...
**ADR-001..020 — все Accepted** и зарегистрированы в INDEX. Действующих противоречий нет. (ADR-017 path-based routing, ADR-018 prod-deploy shared-Traefik + CI/CD — добавлены 2026-06-03 для prod-деплоя `corelysite.shop`; CI/CD-платформа **GitHub Actions** декларирована в стеке — [02-tech-stack → CI/CD-платформа](02-tech-stack.md#cicd-платформа-prod-deploy-adr-018). ADR-019 reconciler-скоуп/graceful-fail LLM, ADR-020 structured-output агентов tool-use+толерантный-парсинг+bounded-retry — прод-фиксы 2026-06-03/04.)
