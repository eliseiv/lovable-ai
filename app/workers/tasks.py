...
@celery_app.task(name="pipeline.task_interview", queue="llm", **_RETRY_KWARGS)
def task_interview(job_id: str) -> None:
    asyncio.run(_interview(job_id))
...
@celery_app.task(name="pipeline.task_spec", queue="llm", **_RETRY_KWARGS)
def task_spec(job_id: str) -> None:
    asyncio.run(_spec(job_id))
...
@celery_app.task(name="pipeline.task_build_request", queue="build", **_RETRY_KWARGS)
def task_build_request(job_id: str) -> None:
    asyncio.run(_build_request(job_id))
...
@celery_app.task(name="pipeline.task_deploy", queue="build", **_RETRY_KWARGS)
def task_deploy(job_id: str) -> None:
    asyncio.run(_deploy(job_id))
...
@celery_app.task(name="pipeline.task_fix", queue="llm", **_RETRY_KWARGS)
def task_fix(job_id: str) -> None:
    asyncio.run(_fix(job_id))
...
@celery_app.task(name="pipeline.task_edit", queue="llm", **_RETRY_KWARGS)
def task_edit(job_id: str) -> None:
    asyncio.run(_edit(job_id))
